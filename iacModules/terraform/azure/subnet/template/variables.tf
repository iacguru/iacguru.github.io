...
variable "temp-subnet-name" {
  type        = string
  description = "Name of the subnet to create."
}

variable "temp-address-prefixes" {
  type        = list(string)
  description = "The address prefixes to use for the subnet."
}

# Optional Variables
variable "temp-service-endpoints" {
  type        = list(string)
...
variable "temp-service-endpoint-policy-ids" {
  type        = list(string)
  description = "The list of IDs of Service Endpoint Policies to associate with the subnet."
  default     = []
}

variable "temp-delegation" {
  type = list(object({
    name         = string
    service-name = string
    actions      = list(string)
